...
export default function ConsultationInvite() {
  return (
    <div className="max-w-[1300px] relative min-h-[300px] sm:min-h-[400px] md:min-h-[500px] flex items-center  overflow-hidden m-auto">
      ...
      {/* Card - Now centered properly */}
      <div className='relative w-[280px] smx:w-[350px] sm:w-[450px] lg:w-[520px] 
                     h-[150px] smx:h-[250px] sm:h-[350px] lg:h-[400px] bg-main 
                     p-[15px] smx:p-[30px] lg:pt-[69px] lg:pr-[45px] lg:pb-[114px] lg:pl-[64px] 
                     text-white mx-4 left-[20px] smx:left-[40px] md:left-[150px]'>
        <h1 className='text-[24px] sm:text-[32px] lg:text-[44px] font-normal 
                      leading-[25px] smx:leading-[30px] sm:leading-[40px] lg:leading-[56px] 
                      mb-[2px] sm:mb-[12px]'>
          Let's talk about your industrial problems
        </h1>
        <p className='text-[12px] smx:text-[16px]'>
          Our team is ready to help you find reliable, efficient solutions for your construction or manufacturing needs.
        </p>
        
        <button className="w-[150px] sm:w-[210px] h-[30px] smx:h-[40px] sm:h-[64px] 
                          bg-black text-white absolute bottom-0 right-0 
                          flex items-center justify-center gap-2 hover:bg-gray-800 transition-colors">
          <span className="flex items-center gap-1 sm:gap-2 leading-none">
            <span className="text-[16px] sm:text-base ">Request a Quote</span>
