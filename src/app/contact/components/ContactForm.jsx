   ...
   />
                    ...
                    <div className='flex flex-col md:flex-row justify-between'>
                      ...
                      <Input onChange={handleChange || ""} stylee="my-1 border-1 w-[100%]  md:w-[47%] h-[48px] p-2 outline-none" type="email"  placeholder="Enter your email"  width='50%'  name="email" value={data.email} />
                       ...
                       <Button type="submit" onClick={handleMessage} stylee="w-[100px] h-[50px] flex items-center justify-center border-2 text-white hover:text-main border-main  hover:bg-transparent mt-6" value="Send" />    
                  </form>
  )
}
